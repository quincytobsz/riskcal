...
class lab extends React.Component {
  constructor(props) {
    super(props)
    this.state = { 
       formValues: [{ countryofresidence: "", age: "",gender:"",smoking:"",diabetes:"",systolicBP:"",totalcholestrol:"" }]
     };
        ...
        <form  onSubmit={this.handleSubmit}>
          {this.state.formValues.map((element, index) => (
            <div className="form-inline" key={index}>
              ...
              <input type="text" name="diabetes" value={element.diabetes || ""} onChange={e => this.handleChange(index, e)} />
              ...
              <input type="text" name="total cholestrol (in mmol)" value={element.totalcholestrol || ""} onChange={e => this.handleChange(index, e)} />
